 ...
 */
package com.itexps.JenkinsTestng;
...
public class TestCase09 {
    ...
    public void testRiya() throws Exception {
      ...
      /*  String s1 = driver.findElement(By.xpath("//*[@id=\"react-root\"]/section/nav/div[2]/div/div/div[3]/div/span/a[1]/button")).getText();
         System.out.println(" Text is " + s1);
         String substr = s1.substring(0, 9);
         try {
         Assert.assertEquals("369 posts", substr);
         } catch (Error e) {
